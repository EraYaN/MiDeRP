...
Met behulp van het CircuitLab (SPICE) voeren wij een DC-sweep uit voor V1. Door de spanning over de diode te delen door de stroom die erdoorheen loopt kunnen wij de differentiële weerstand bepalen. Deze differentiële weerstand staat geplot in figuur \ref{fig:rdv}. Op ons instelpunt van 2V bedraagt de differentiële weerstand $412.9\Omega$
\begin{figure}[H] 
	\centering
