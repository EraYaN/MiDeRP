...
Voor het Director programma wordt voornamelijk C\# en WPF gebruikt, wat zorgt voor een gebruikersvriendelijke interface. Echter, gebruiken we wel C/C++ om de navigatie en de communicatie te coderen.\wl
