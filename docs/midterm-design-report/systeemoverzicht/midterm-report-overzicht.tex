...
\label{ch:systeem}
Het systeem bestaat uit driehoofdblokken, de FPGA met de logica erop, de twee xBee modules voor de communicatie en het Director programma dat op de PC draait.
In figuur \ref{fig:topLevelSystem} is een blokschema van het systeem afgebeeld, hierin is de robot nog verder uitgesplitst. 
